...
* *content-aggregator*: Convert file mode to mode bits when reading file from git repository (#359)
...
* *playbook-builder*: Renable PLAYBOOK environment variable to ANTORA_PLAYBOOK
