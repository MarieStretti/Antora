...
*page-composer*: Allow site.url in playbook to be a root-relative pathname (#478)
*page-composer*: Site site.path in UI model to empty string if site.url in playbook is a root-relative pathname (#478)
*redirect-producer*: Build redirects even when site.url in playbook is a root-relative pathname (#478)
