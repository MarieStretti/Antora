...
* *content-aggregator*: Include start path and reference name in error messages about antora.yml (#267)
...
* Document that a .nojekyll file must be used to publish an Antora-generated site to GitHub Pages (#194)
* Explain how to configure Antora to connect to private repositories listed in the playbook file (#139)
* Document trick to prevent Antora from using the worktree for a local URL (#236)
