...
* *asciidoc-loader*: Fixed memory leak caused by Asciidoctor converter extension (#306)
...
* *content-classifier*: Also look for partial files in the partials folder directly inside the module folder (in addition to pages/_partials) (#254)
