...
For a detailed list of current development tasks, refer to the core components {uri-board}[issue board], {uri-issues}[issue tracker] and {uri-milestones}[milestones].
