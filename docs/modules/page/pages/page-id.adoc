...
Page::
The path to the page's source file in the module, including any leading topic directories and the [.path]_.adoc_ file extension.
...
[source,asciidoc]
1.0@antora:ROOT:how-antora-works.adoc
