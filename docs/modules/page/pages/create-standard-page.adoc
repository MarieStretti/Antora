...
* xref:asciidoc:page-header.adoc#page-meta[metadata], such as author information, a page description, and keywords
* environment settings
* xref:asciidoc:page-header.adoc#page-attrs[built-in document attributes], such as section numbering
