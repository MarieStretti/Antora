...
:description: How to enlist navigation files in a component descriptor so the Antora assembles them into a component navigation menu.
:keywords: nav.adoc, antora.yml, register navigation files, add page link lists to a menu
// Settings
:idprefix:
:idseparator: -
...
The `nav` key accepts a list of xref:source-files.adoc[navigation files].
