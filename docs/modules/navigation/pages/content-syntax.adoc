...
When content is linked, also known as anchored, then a website visitor can click on the visible content and jump to another page or resource.
...
*Whether in the content of a page or in a navigation file, when a page is part of your site, you should always create links to it using the Antora cross referencing system.*

=== In-module page links

The most common items in a navigation list are cross references to pages in the module where the navigation file is stored.
...
Using the xref:asciidoc:page-to-page-xref.adoc[appropriate page ID pattern], you can link to any document in the site from a navigation list, whether it's stored in a different module or component.
