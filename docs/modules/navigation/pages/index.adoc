...
When you want the contents of a navigation source file to be published to a component's navigation menu, you need to register the source file in the appropriate component descriptor file.

=== 2 Input: Navigation enlistment
...
When you run Antora, it will only use the registered navigation source files to create the component menu.

=== 3 Publish: Component navigation menu

Antora collects the contents of each registered navigation source file, puts the contents in the order the files are listed under the `nav` key, and publishes a fully assembled navigation menu for the component to the site.
...
When you have several components and/or several versions of one or more components, Antora will assemble an aggregated list of the components and their versions.
