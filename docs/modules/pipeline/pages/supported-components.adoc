...
At this time, only Core components that are the same version work together, i.e., if you want to use the Content Classifier and Page Composer in a custom pipeline, make sure each component is the same version.
