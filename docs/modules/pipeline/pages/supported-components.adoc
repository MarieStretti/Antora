...
:table-caption!:
// URIs
:uri-antora-lcs: https://gitlab.com/antora/antora/blob/master/LICENSE
...
If you use the CLI with the default site generator, then you just have to keep the versions of the @antora/cli and @antora/site-generator-default in sync.
If you make a custom site generator, then you are responsible for keeping each individual component you use in sync.
