...
The site can be published in multiple formats to multiple locations over multiple protocols using xref:playbook:output-keys.adoc#output-provider[built-in and custom destination providers].
