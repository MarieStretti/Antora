...
Instead, they must be referenced by an xref:page-partials.adoc[include directive] in a standard page.
...
* xref:page-partials.adoc[Include a partial page in a standard page with AsciiDoc]
* xref:component-structure.adoc[Documentation component overview]
