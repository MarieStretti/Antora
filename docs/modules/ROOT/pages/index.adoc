...
As a tech writer, you simply author content in xref:asciidoc:asciidoc.adoc[AsciiDoc], Antora's content markup language, then save those files under a standard project structure inside one or more content repositories.
