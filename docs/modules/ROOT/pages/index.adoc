...
If you already have a documentation component set up and you're ready to create your first site, check that you've met Antora's xref:supported-platforms.adoc[system requirements], xref:install/install-antora.adoc[install Antora], and then xref:run-antora.adoc[generate your site] using Antora.

If you want to jump into writing, learn how to use the xref:asciidoc:index.adoc[AsciiDoc syntax] to xref:page:index.adoc[make documentation pages].
