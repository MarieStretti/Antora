...
Using {uri-asciidoctor}[Asciidoctor], it then converts all content files to embeddable HTML and resolves links between pages.

Once the conversion is complete, Antora passes the embeddable HTML as part of a UI data model to Handlebars templates provided by the UI bundle to create the web pages.
