...
A link to an attachment is created in a page using the xref:asciidoc:link-to-attachment.adoc[AsciiDoc link macro].
...
A partial AsciiDoc file is inserted into a page using the xref:asciidoc:include-partial-page.adoc[AsciiDoc include directive].
