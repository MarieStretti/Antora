...
Now that you have Node, you're ready to xref:install-antora.adoc[install Antora].
...
Now that you've upgraded Node, you're ready to xref:install-antora.adoc[install Antora].

== What's next?

Once you've installed the base build tools and Node 8, it's time to xref:install-antora.adoc[install Antora].
