...
{asterisk} To use Antora on Alpine Linux, you must force nodegit to be recompiled using BUILD_ONLY=true (see xref:install/troubleshoot-nodegit.adoc[Troubleshooting nodegit]).
