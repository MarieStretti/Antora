...
The demo consists of a {url-demo-project}[playbook repository] containing a {url-demo-playbook}[playbook file] and several content repositories ({url-demo-component-a}[component-a] and {url-demo-component-b}[component-b]) to which that playbook refers.
