...
Help and support is never in short supply.
...
.Notes
--
- create references between pages that are based on abstract coordinates instead of coupled to the output location (coupling to the URL incurs a cost); references can be validated and managed
