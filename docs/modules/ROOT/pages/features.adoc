...
A documentation pipeline that can manage lots of source repositories, version branches, and publishing environments.
...
Create, remix, test and publish sites from documentation stored in multiple repositories and branches.
Create documentation sites from files stored in multiple repositories and branches.
Remix
// short form
...
Use branches to release documentation versions just like software versions.
...
An Antora playbook let's you control what documentation and what versions of that documentation gets published to a site.
