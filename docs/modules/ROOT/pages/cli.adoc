...
|--clean
|Remove the  xref:playbook:playbook-keys.adoc#clean-key[previous output directory] before generating the site.
|Boolean
|false
...
This option overrides the xref:playbook:playbook-keys.adoc#dir-key[output dir value] specified in the playbook.
|String
|[.path]_build/site_
