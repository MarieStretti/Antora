...
* [x] How to launch the site generator.
* [x] How to preview the generated site locally.

Once you've configured your playbook, it's time to run Antora.
//Now that you've told Antora which content to use and which UI to apply to that content, it's time to run it.

== Run Antora

You invoke Antora by passing the `generate` command to Node.
This command runs the [.path]_generate.js_ script.
...
The repositories are cached under the [.path]_build/sources_ directory.
