...
:url-milestone-2-0-0: {url-issues}?scope=all&state=closed&label_name%5B%5D=%5BVersion%5D%202.0.0
:url-milestone-2-0-1: {url-issues}?scope=all&state=closed&label_name%5B%5D=%5BVersion%5D%202.0.1
...
_**Release date:** 2019.08.22 | *Issue Label:* {url-milestone-2-0-1}[2.0.1^]_
...
_**Release date:** 2018.12.25 | *Issue label:* {url-milestone-2-0-0}[2.0.0^]_
