...
In fact, the https://gitlab.com/antora/docs.antora.org/blob/master/.gitlab-ci.yml[CI job for the Antora documentation site] uses this image to generate the documentation you're currently reading.
...
Since the container stays running, you can more quickly execute the `antora` command.
