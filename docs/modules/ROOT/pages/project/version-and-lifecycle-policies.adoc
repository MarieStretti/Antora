...
Each major version of the Antora Core components and Core UI Model is supported for at least one year after the major version enters General Availability (GA).
