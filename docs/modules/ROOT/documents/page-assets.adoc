...
// See <<attachment-files, Attachment files>> for file name and file location guidelines.
...
//See <<image-files, Image files>> for file name and file location guidelines.
...
TIP: Insert animated GIFs and SVGs with the <<insert-image,image macro>>.
