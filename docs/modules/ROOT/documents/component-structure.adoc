...
* the ability to define page references that span component versions (and thus repositories), are not coupled to output URL (source-to-source), and can be automatically updated by a tool when source files are moved and renamed
...
xref:module.adoc#root[modules/ROOT/] ::
_Required_; _Reserved_
+
...
xref:module.adoc#images-dir[<module>/assets/images/] ::
_Optional_; _Reserved_
+
...
xref:module.adoc#pages-dir[<module>/pages/] ::
_Required_; _Reserved_
+
...
xref:module.adoc#partials-dir[<module>/pages/_partials/] ::
_Optional_; _Reserved_
+
