...
Simple documentation components may never need more than a ROOT module.
...
Instead, you should either host them in a binary repository such as Bintray or S3, or use git LFS.
