...
Initializing the project means downloading and installing Antora and its dependencies.
These tasks are xref:ROOT:install-prerequisites.adoc#yarn[managed by Yarn].
