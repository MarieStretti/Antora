...
Additionally, certain settings in the playbook file can be overridden using xref:ROOT:cli.adoc[CLI options] or environment variables, which allows an operations team to tailor the behavior for specific environments, such as production.
