...
Regardless of the format, a playbook contains structured xref:playbook-schema.adoc[key sets] for specifying general site properties, content and UI input sources, and published output destinations and providers.
