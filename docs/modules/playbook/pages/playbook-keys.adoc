...
* xref:configure-output.adoc#archive-path[Publish site as a ZIP file]
* xref:configure-output.adoc#multiple-destinations[Specify multiple destinations]
...
* xref:configure-output.adoc#archive-path[Specify ZIP file]
* xref:configure-output.adoc#multiple-destinations[Specify relative and absolute provider paths]
