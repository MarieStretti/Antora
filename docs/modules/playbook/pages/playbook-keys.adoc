...
content: # <7>
  sources: # <8>
  - url: https://gitlab.com/antora/demo/demo-component-a # <9>
    branches: master # <10>
    start_path: docs # <11>
ui: # <12>
...
<14> Published output key
<15> Clean output directory key
<16> Output directory key
<17> Output destinations key
<18> Output provider key
