...
If you want the site's start page to be a specific version of the assigned page, include the xref:page:page-id.adoc#id-version[version name in the page ID].
