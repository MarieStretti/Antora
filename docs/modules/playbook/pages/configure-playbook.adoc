...
The default destination is the filesystem (`fs`).
...
The default, built-in provider is the filesystem (`fs`).
Antora also has one other built-in provider, `archive`.
The archive provider publishes the site as a ZIP archive.
