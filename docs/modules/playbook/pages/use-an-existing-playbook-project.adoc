...
* xref:ROOT:run-antora-to-generate-site.adoc[Run Antora] to generate the site.
* Modify the playbook to xref:playbook-schema.adoc[configure the site properties, inputs, and output].
...
Once you've installed Antora and its dependencies, you can xref:ROOT:run-antora-to-generate-site.adoc[generate your site] with your playbook.
