...
content: # <7>
  ...
  - url: https://gitlab.com/antora/demo/demo-component-a.git # <9>
    ...
    start_path: docs # <12>
ui: # <13>
  bundle: https://gitlab.com/antora/antora-ui-default/-/jobs/artifacts/master/raw/build/ui-bundle.zip?job=bundle-stable # <14>
  start_path: dark-theme # <15>
...
The bundle key accepts a URL or local filesystem path to a UI bundle ZIP archive.
...
The start path key is the path inside the bundle from which UI files should be selected.
