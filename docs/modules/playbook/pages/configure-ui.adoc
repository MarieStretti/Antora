...
The url key (`url`) under the `bundle` subcategory defines the location Antora should look to find a UI archive in {uri-zip-file-format}[ZIP] format (i.e., UI bundle).
