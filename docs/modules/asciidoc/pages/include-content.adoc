...
:uri-tags: {uri-adoc-manual}/#by-tagged-regions
:uri-leveloffset: {uri-adoc-manual}/#include-partitioning
:uri-indent: {uri-adoc-manual}/#normalize-block-indentation
...
* {uri-leveloffset}[Offset section headings with leveloffset^]
* {uri-tags}[Select regions of content with tags^]
* {uri-indent}[Normalize block indentation with indent^]
