...
When the partial file and the page file are in the same component, but different modules, enter the partial's module, family (`partial$`), and the name of the partial file.
...
When the partial file and the page file belong to different components, enter the partial's component, module, family (`partial$`), and the name of the partial file.
...
In the next example, the page will include the partial from the 2.0 version of the catalog component.

----
\include::2.0@catalog::partial$ref/definitions.adoc[]
----
