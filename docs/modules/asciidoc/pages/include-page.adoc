...
Let's break down the AsciiDoc syntax and resource coordinates you need to include a standard page into another standard page.

----
\include::version@component:module:page$name-of-file.adoc[optional attributes]
----
...
. Enter the xref:page:resource-id.adoc[resource ID] of the page file.
...
. The resource ID must contain the `page$` family.
+
[subs=quotes]
----
\include::version@component:module:**page$**name-of-file.adoc[optional attributes]
