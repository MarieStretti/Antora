...
This syntax in also used to xref:navigation:link-syntax-and-content.adoc[add pages to your navigation files].

== Reference by page ID

In Antora, a cross reference, commonly called an xref, needs a xref:ROOT:page-id.adoc[page ID] in order to link to another site page.
