...
{asterisk} To use Antora on Alpine Linux, you must force nodegit to be recompiled using BUILD_ONLY=true (see instructions below).
...
Run `nvm list available` for a list of all available Node versions.
