...
IMPORTANT: The version, roadmap, and support policies described in this section will take affect when the initial stable release of the Antora CLI and default site generator packages are published.

The Antora CLI and default site generator packages are released together and follow the https://semver.org[semantic versioning] rules.
...
Each major version of the Antora default site generator is maintained for at least X years after the initial public stable release.
